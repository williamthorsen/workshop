...
import { type InlaySite, stripInlays } from '../inlays/stripInlays.ts';
...
import { type DeployedNameLookup, rewriteTokens } from '../tokens/rewriteTokens.ts';
import { expandTransclusions, type Segment, type TransclusionSource } from '../transclusion/expandTransclusions.ts';
