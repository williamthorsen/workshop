 ...
 *
 * Detecting it without `parseArgs` lets a flag-parse failure still be reported through the JSON error envelope.
 * The scan matches only `--json`, and stops at the `--` terminator, after which arguments are positional rather
 * than flags.
 *
