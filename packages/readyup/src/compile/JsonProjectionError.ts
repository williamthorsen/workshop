 ...
 * projection, which lets a reader report a file that is present and well-formed while the fields
 * to which a kit pinned are gone.
 */
 ...
 * has usually already named as it knows it. Reading the diagnosis off `reason` keeps the two
