...
export interface Workspace {
  /** Workspace directory, relative to the directory to which discovery was anchored. `'.'` for the repo root. */
  readonly dir: string;
...
/** Builds a `Workspace`, deep-freezing the manifest that it is given. */
