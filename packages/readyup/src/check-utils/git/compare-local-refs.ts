...
/** Returns the name of the first ref that does not exist, or `undefined` when both exist. */
...
/** Returns the ahead/behind counts between two refs, or `undefined` when they cannot be computed. */
