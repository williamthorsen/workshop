/** A conceptual topic offered by `rdy help`, and the README section that covers it. */
...
export const TOPICS: Readonly<Record<string, HelpTopic>> = {
  ...
  utils: { heading: 'Check utilities', summary: 'Helpers that a kit imports from readyup' },
};
