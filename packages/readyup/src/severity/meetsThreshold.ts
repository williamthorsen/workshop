 ...
 * responsibility, and the throw makes that a contract rather than an assumption: An unranked
...
/** Throws when a severity has no rank, naming the role in which it was supplied. */
