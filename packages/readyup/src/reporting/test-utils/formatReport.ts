import type { JsonKitErrorEntry } from '../../schemas/reportSchema.ts';
import {
  formatJsonReport,
  type FormatJsonReportOptions,
  type KitInput,
  type KitResultInput,
} from '../formatJsonReport.ts';
 ...
 *
 * An override stands in for its CLI flag: It appears at the top level only when supplied, and resolves
